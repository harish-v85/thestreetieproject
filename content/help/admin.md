...
1. Open **Manage** → **Dogs**, then **Edit** for the dog.
...
1. Open **Manage** → **Localities** in the top navigation.
...
1. Open **Manage** → **Neighbourhoods** in the top navigation.
