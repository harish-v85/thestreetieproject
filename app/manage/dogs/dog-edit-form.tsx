...
import { EditDogFormToolbar } from "@/components/edit-dog-form-toolbar";
...
export const EDIT_DOG_FORM_ID = "edit-dog-form";
...
export function DogEditForm({
  ...
  return (
    <>
      <EditDogFormToolbar formId={EDIT_DOG_FORM_ID} dogSlug={dog.slug} pending={pending} />
      <form id={EDIT_DOG_FORM_ID} action={formAction} className="space-y-0">
        <div className="overflow-hidden rounded-2xl border border-black/5 bg-white p-4 shadow-sm sm:p-6">
          <section id="edit-section-profile" className="scroll-mt-40">
            ...
            <div className="mt-5 grid gap-4 sm:grid-cols-2">
              ...
              <div className="sm:col-span-2">
                ...
                <textarea
                  ...
                  rows={3}
                  placeholder="Optional — shown on the public profile when filled."
                  defaultValue={dog.known_issues_disabilities ?? ""}
          ...
          <section
            ...
            className="scroll-mt-40 mt-10 border-t border-black/10 pt-10"
          >
